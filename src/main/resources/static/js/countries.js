...
s_a[69] = "Adama|Adis Abeba (Addis Ababa)|Addigrat|Adwa|Agaro|Alaba|Ambo|Arba Minch|Asaita|Asella|Asosa|Awasa|Axum|Alamata|Babille|Babille|Baco|Badme|Bahir Dar|Bati|Bedele|Bichena|Bishoftu|Burie Damote|Butajira|chelenko|Dessie|Dabat|Debre Berhan|Debre Marqos|Debre Tabor|Debre Werq|Debre Zebit|Dejen|Dembidolo|Dessie (Dese)|Dila|Dire Dawa|Dolo Bay|Dolo Odo|Durame|Dalocha|Enijibara|Finicha'a|Fiche|Finote Selam|Gondar|Gambela|Gelemso|Ghimbi|Goba|Gode|Gondar|Gore|Harar|Holeta|Hosaena|Humera|Jijiga|Jimma|Jinka|Kabri Dar|Kebri Mangest|Kobo|Kombolcha|Lalibela|Konso|Kulubi|Limmu Genet|Maychew|Mek'ele|Metemma|Metu|Mizan Teferi|Mojo|Mota|Moyale|Negele Boran|Nekemte|Robe, Bale|Shashamane|Shire|Sodo (Wolaita Sodo)|Sodore|Tefki|Tippi|Wereta|Woldia|Wolaita Sodo|Waliso|Wuchale|Worabe|Yabelo|Yirga Alem|Ziway";
